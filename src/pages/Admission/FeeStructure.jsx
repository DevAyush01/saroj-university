...
const SIUFeeStructure = () => {
  ...
  const originalGlobalInstitutes = useMemo( ()=>[
    ...
    return programs.map(program => {
      ...
      // Format annual/tuition fee with Indian Rupee symbol and locale string
      let annualFee = "N/A";
  ...
  //flatten and prepare programs for filtering. 
const allPrograms = useMemo( ()=>{
 const regular = originalInstitutes.flatMap( institute =>
  institute.programs.map( program => ({
    ...
    searchableText: `${institute.name} ${institute.domain} ${institute.degree} ${program.specializations}`.toLowerCase()
  }))
  )
      ...
      <Helmet>
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden transition-all duration-300 hover:shadow-2xl max-w-6xl w-full">
          <div className="p-8">
            ...
            <div className="mb-8 p-6 bg-white rounded-lg shadow-md border border-gray-200 flex flex-col md:flex-row items-center justify-between gap-4">
              {/* Search Input */}
              ...
              <div className="relative w-full md:w-1/4">
                ...
                <select
                  ...
                  className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-md appearance-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 bg-white"
                >
            ...
            <div className="mt-8 p-6 bg-blue-50 rounded-lg border border-blue-100 shadow-md">
              ...
              <ul className="list-disc pl-5 text-blue-700 space-y-1">
                ...
                <li>The "Law" domain is not included as no data was provided for it in the original dataset.</li>
              </ul>
            </div>
          </div>
        </div>
