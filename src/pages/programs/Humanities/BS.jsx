...
const BSPage = () => {
  ...
  const curriculum = [
    ...
    },
    {
      semester: 'Semester 4',
      courses: [
        'Regional Studies (e.g., Asia-Pacific)',
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            A comprehensive program designed for students passionate about global politics, diplomacy, and cross-cultural understanding.
          </p>
        </div>
          ...
          {expandedSections.overview && (
            <div className="px-6 pb-6">
              <p className="text-gray-700 mb-4">
                The BS in International Relations program provides students with a robust foundation in the complexities of global politics, economics, and cultures. Through a rigorous curriculum, students will develop analytical skills to understand international systems and critically evaluate global issues.
              </p>
              <p className="text-gray-700 mb-4">
                This program prepares graduates for careers in diplomacy, international organizations, non-governmental organizations, global business, and further postgraduate studies in related fields.
              </p>
              <div className="mt-6">
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden mb-12">
          ...
          >
            <h2 className="text-2xl font-bold text-gray-800 flex items-center">
              <FaBookOpen className="w-6 h-6 text-yellow-600 mr-3" />
              Curriculum Structure
            </h2>
            <FaChevronDown className={`w-5 h-5 text-gray-500 transition-transform ${expandedSections.curriculum ? 'rotate-180' : ''}`} />
          </button>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {curriculum.map((semester, index) => (
                  <div key={index} className="border border-gray-200 rounded-lg p-4">
                    <h3 className="font-semibold text-lg mb-3 text-yellow-700">{semester.semester}</h3>
                    <ul className="space-y-2">
                      {semester.courses.map((course, i) => (
                        <li key={i} className="text-gray-700 text-sm">• {course}</li>
                      ))}
                    </ul>
                  </div>
                ))}
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden mb-12">
          ...
          {expandedSections.fees && (
            <div className="px-6 pb-6">
              <p className="text-gray-700 mb-4">
                The approximate annual fee for the BS in International Relations program is:
              </p>
              <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    <tr>
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">BS (International Relations)</td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">₹95,000</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              <p className="text-xs text-gray-500 mt-4">
                * Fees are approximate and subject to change. This covers tuition and basic library access. Additional charges for specific workshops, international immersion programs, or field trips may apply.
              </p>
            </div>
          )}
        </div>
        ...
        <div className="text-center bg-yellow-700 text-white p-12 rounded-lg">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Join our BS in International Relations program and become a global citizen ready to make an impact.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a 
              href="/apply" 
              className="bg-white text-yellow-700 font-bold py-3 px-8 rounded-lg hover:bg-gray-100 transition-colors flex items-center justify-center"
            >
              <FaFileAlt className="mr-2" /> Apply Now
            </a>
            <a 
              href="/brochure-international-relations.pdf" // Placeholder link for brochure
              className="border-2 border-white text-white font-bold py-3 px-8 rounded-lg hover:bg-white hover:text-yellow-700 transition-colors flex items-center justify-center"
            >
