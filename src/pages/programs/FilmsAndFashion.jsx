...
import { 
  FaFilm, FaTshirt, FaCamera, FaPalette, // Existing icons
  FaChevronDown, FaFileAlt,FaChartLine ,
  ...
  const allPrograms = [ // Renamed 'programs' to 'allPrograms' for consistency
    {
      ...
      highlights: [
        'Cinematography Techniques & Lighting',
        'Digital Editing & Visual Effects',
        'Directing & Storytelling Fundamentals',
    ...
    },
    {
      ...
      highlights: [
        'Textile Science & Fabric Manipulation',
        'Fashion Illustration & CAD',
        'Pattern Making & Garment Construction',
        'Fashion History & Theory',
        'Collection Development & Portfolio Presentation'
      ]
    },
    {
      id: 'ma-screenwriting',
      ...
      highlights: [
        ...
        'TV Series Writing & Showrunning',
        'Character & Dialogue Craft',
        'Story Structure & Plotting',
        'Industry Pitching & Networking'
      ]
    },
    {
    ...
    },
    {
      ...
      highlights: [
        ...
        'Digital Image Editing (Photoshop/Lightroom)',
        'Composition & Lighting Principles',
    ...
    <Layout>
      <div className="container mx-auto px-4 py-12 max-w-6xl">
        ...
        >
          ...
          <div className="bg-purple-700 rounded-t-xl px-8 py-6 text-white flex items-center">
          ...
          <div className="px-8 py-6 bg-purple-50 border-t border-gray-200 text-center">
            <motion.a 
              href="/apply" 
              className="bg-purple-600 hover:bg-purple-700 text-white font-bold py-3 px-8 rounded-lg shadow-md flex items-center justify-center mx-auto w-fit"
