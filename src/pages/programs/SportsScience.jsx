  ...
  const programs = [
    {
      ...
      highlights: [
        ...
        'Athlete assessment and training'
      ],
      ...
      <div className="container mx-auto px-4 py-12 max-w-6xl">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Advancing human performance and well-being through scientific study and practical application.
          </p>
        ...
        >
                      ...
                      <div className="ml-4">
                        ...
                        <div className="flex items-center mt-1">
                          ...
                          {program.category === 'Undergraduate' && (
                            <span className="text-xs bg-red-100 text-red-800 px-2 py-1 rounded">UG</span>
                          )}
                          {program.category === 'Postgraduate' && (
                            <span className="text-xs bg-red-200 text-red-800 px-2 py-1 rounded">PG</span>
                          )}
                          {program.category === 'Diploma' && (
                            <span className="text-xs bg-yellow-100 text-yellow-800 px-2 py-1 rounded">Diploma</span>
                          )}
                          {program.category === 'Ph.D' && (
                            <span className="text-xs bg-purple-100 text-purple-800 px-2 py-1 rounded">Ph.D</span>
                          )}
                        </div>
                      </div>
                    </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 px-8 py-6 bg-gray-50 border-t border-gray-200">
            <div className="bg-blue-50 p-6 rounded-lg">
              ...
              <p className="text-gray-700">
                Access to modern sports labs, physiology equipment, and dedicated training zones for practical learning.
              </p>
            </div>
            <div className="bg-purple-50 p-6 rounded-lg">
              ...
              <p className="text-gray-700">
                Opportunities for internships with sports academies, fitness centers, and professional teams.
              </p>
            </div>
            <div className="bg-orange-50 p-6 rounded-lg">
              ...
              <p className="text-gray-700">
                Learn from leading experts and researchers in sports science, exercise physiology, and nutrition.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center px-8 py-6 bg-red-50">
            ...
            <p className="mt-4 text-gray-600">
              Questions about our programs? <a href="/contact" className="text-red-600 hover:underline">Contact our admissions team</a>
            </p>
          </div>
        </motion.div>
      </div>
