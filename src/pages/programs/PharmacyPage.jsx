...
import { FaPills, FaFlask, FaMedkit, FaUserMd, FaChevronDown, FaFileAlt } from 'react-icons/fa';
  ...
  const programs = [
    {
      ...
      description: 'Comprehensive clinical training in pharmaceutical care.',
      highlights: [
        'Pharmacotherapy',
        'Clinical rotations',
        'Patient counseling',
    ...
    },
    {
      ...
      description: 'Foundational knowledge in pharmaceutical sciences.',
      highlights: [
      ...
      <div className="container mx-auto px-4 py-12 max-w-6xl">
        ...
        >
          <div className="flex justify-center mb-4">
            <FaMedkit className="text-5xl text-green-600" />
          </div>
        ...
        >
          <div className="bg-green-700 px-8 py-6 flex items-center">
            <FaUserMd className="text-3xl text-white mr-4" />
            <div>
              <h2 className="text-2xl font-bold text-white">Pharmaceutical Sciences</h2>
              <p className="text-green-100 mt-1">Expertise in drug development and patient care</p>
            </div>
          </div>
          ...
          <div className="px-8 py-6 bg-green-50 border-t border-gray-200 text-center">
            <motion.a 
              href="/apply" 
              className="inline-block bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-8 rounded-lg shadow-md flex items-center justify-center mx-auto w-fit"
