...
import { FaBook, FaHistory, FaLanguage, FaGlobe, FaChevronDown, FaFileAlt } from 'react-icons/fa';
  ...
  const programs = [
    {
      ...
      description: 'Explore literary traditions across cultures and historical periods.',
      highlights: [
    ...
    },
    {
      ...
      description: 'Advanced study of historical events and their interpretations.',
      highlights: [
        'Historiography',
        'Archival research',
  ...
  return (
    <Layout>
      <div className="container mx-auto px-4 py-12 max-w-6xl">
        ...
        >
          <div className="bg-indigo-700 px-8 py-6 flex items-center">
            <FaGlobe className="text-3xl text-white mr-4" />
            <div>
              <h2 className="text-2xl font-bold text-white">Humanities & Liberal Arts</h2>
              <p className="text-indigo-100 mt-1">Understanding the human experience through critical inquiry</p>
            </div>
          </div>
          ...
          <div className="px-8 py-6 bg-indigo-50 border-t border-gray-200 text-center">
            <motion.a 
              href="/apply" 
              className="inline-block bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 px-8 rounded-lg shadow-md flex items-center justify-center mx-auto w-fit"
