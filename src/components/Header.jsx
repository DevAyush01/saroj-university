  ...
  },
  {
    ...
    columns: [
      // ACADEMIA LAYOUT
      {
        ...
        items: [{ title: "Saroj Institute of Artificial Intelligence (SIAI)" }, { title: "Saroj Institute of Management & Technology (SIMTI)", approval: "AICTE Approved" }, { title: "Saroj Institute of Basic & Health Sciences (SIBHS)" }, { title: "Saroj Institute of Humanities & Education (SHIE)" }, { title: "Saroj Institute of Sports Sciences & Research (SISSRI)" }, { title: "Saroj Institute of Entrepreneurship & Business (SIEB)" }, { title: "Saroj Institute of Film and Fashion (SIFF)", approval: "AICTE Approved" }, { title: "Lucknow Institute of Pharmacy (LIP)", approval: "PCI Approved" }],
      },
      {
        heading: "PROGRAMS & FEES",
        type: "fees", // Custom type for fee structure
        items: [{ title: "Saroj Institute of Artificial Intelligence- Programs & Fee" }, { title: "Saroj Institute of Management & Technology- Programs & Fee " }, { title: "Saroj Institute of Basic & Health Sciences- Programs & Fee " }, { title: "Saroj Institute of Humanities & Education- Programs & Fee " }, { title: "Saroj Institute of Sports Sciences & Research- Programs & Fee " }, { title: "Saroj Institute of Entrepreneurship & Business- Programs & Fee" }, { title: "Saroj Institute of Film and Fashion- Programs & Fee" }, { title: "Lucknow Institute of Pharmacy- Programs & Fee" }],
      },
      {
                                        ...
                                        {column.items.map((subItem, subItemIndex) => (
                                          <li key={`${subItem.path}-${subItemIndex}`} className='mb-1'>
                                            {subItem.collaboration_link ? (
                                              <a href={subItem.collaboration_link} target='_blank' rel='noopener noreferrer' className='text-gray-700 hover:text-orange-500 transition-colors duration-200 text-sm flex items-center justify-between group' onClick={closeAllMenus}>
