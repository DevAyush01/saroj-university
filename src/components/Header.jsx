  ...
  },
  {
    ...
    columns: [
      // ACADEMIA LAYOUT
      {
        ...
        items: [{ title: "Saroj Institute of Artificial Intelligence (SIAI)" , path: "/academics/Saroj-Institute-of-Artificial-Intelligence"}, { title: "Saroj Institute of Management & Technology (SIMTI)", approval: "AICTE Approved", path: "/academics/Saroj-Institute-of-Management-and-Technology" }, { title: "Saroj Institute of Basic & Health Sciences (SIBHS)", path: "/academics/Saroj-Institute-of-Basic-and-Health-Sciences" }, { title: "Saroj Institute of Humanities & Education (SHIE)" , path: "/academics/Saroj-Institute-of-Humanities-and-Education"}, { title: "Saroj Institute of Sports Sciences & Research (SISSRI)" ,path: "/academics/Saroj-Institute-of-Sports-Science-and-Research" }, { title: "Saroj Institute of Entrepreneurship & Business (SIEB)" , path: "/academics/Saroj-Insitute-of-Entrepreneurship-and-Business"}, { title: "Saroj Institute of Film and Fashion (SIFF)", approval: "AICTE Approved", path: "/academics/Saroj-Institute-of-Film-and-Fashion" }, { title: "Lucknow Institute of Pharmacy (LIP)", approval: "PCI Approved", path: "/academics/Lucknow-Institute-of-Pharmacy"}],
      },
      {
