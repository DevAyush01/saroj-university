  ...
  return (
    <div className="relative bg-gradient-to-br from-blue-50 to-white overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        ...
        ></div>
        <div 
          className="absolute bottom-10 -right-10 w-80 h-80 rounded-full bg-yellow-100 opacity-20"
          style={{ willChange: 'transform' }}
        ></div>
      </div>
      
      <div className="relative z-10 max-w-full mx-auto px-4 sm:px-6 lg:px-8 pt-24">
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-start">
          ...
          <div className="lg:w-[30%] pt-8">
            ...
            <div className="flex flex-col gap-3 mb-8">
              <button
                className="relative overflow-hidden group text-white font-medium py-3 px-6 rounded-lg shadow-lg hover:shadow-xl flex items-center justify-center gap-2 transition-all duration-300"
                style={{ 
              ...
              <button
                className="flex items-center justify-center gap-2 font-medium py-3 px-6 rounded-lg border transition-all duration-300 hover:shadow-md"
                style={{
                  color: primaryBlue,
          ...
          <div className="lg:w-[70%] mt-6">
            ...
            <div className="mb-6 ">
              <h3 className="text-4xl font-funneldisplay font-semibold text-black mb-2">
            ...
            <div className="rounded-xl overflow-hidden shadow-2xl border-4 border-white relative">
                      ...
                      <div className="relative z-10 h-full flex flex-col justify-end p-8 md:p-12">
                        <div className="max-w-2xl">
                          ...
                          <button className="flex items-center gap-2 text-white group mt-6">
                            <span className="font-medium px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm hover:bg-white/20 transition-all duration-300 border border-white/20">
                              {slide.cta}
                            </span>
                            <ArrowRight
                              size={18}
              ...
              <div className="absolute z-10 top-1/2 w-full flex justify-between px-4 transform -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <button className="swiper-button-prev bg-white/30 backdrop-blur-sm rounded-full p-3 hover:bg-white/50 transition-all duration-300">
                  <ArrowRight size={24} className="text-white rotate-180" />
                </button>
                <button className="swiper-button-next bg-white/30 backdrop-blur-sm rounded-full p-3 hover:bg-white/50 transition-all duration-300">
